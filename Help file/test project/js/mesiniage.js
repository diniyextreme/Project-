...
function postProcess(currentSlide){
    ...
    if (currentSlide == 1 || currentSlide == 2 || currentSlide == 3 || currentSlide == 4 || currentSlide == 5 || currentSlide == 6 || currentSlide == 7 || currentSlide == 8) $("#logo").attr("src", "asset/img/mesiniaga-white-logo.png");
